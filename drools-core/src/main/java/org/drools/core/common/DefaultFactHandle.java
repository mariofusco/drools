...
public class DefaultFactHandle extends AbstractBaseLinkedListNode<DefaultFactHandle>
    ...
    protected static class CompositeLinkedTuples implements LinkedTuples {
        ...
        @Override
        public void clearLeftTuples() {
            Stream.of( partitionedTuples ).forEach( LinkedTuples::clearLeftTuples );
        }

        @Override
        public void clearRightTuples() {
            Stream.of( partitionedTuples ).forEach( LinkedTuples::clearRightTuples );
        }

        @Override
        public void forEachRightTuple( Consumer<RightTuple> rightTupleConsumer ) {
            Stream.of( partitionedTuples ).forEach( t -> t.forEachRightTuple( rightTupleConsumer ) );
        }
        ...
        @Override
        public void forEachLeftTuple( Consumer<LeftTuple> leftTupleConsumer ) {
            Stream.of( partitionedTuples ).forEach( t -> t.forEachLeftTuple( leftTupleConsumer ) );
        }
