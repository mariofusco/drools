...
public class CompositeDefaultAgenda implements Externalizable, InternalAgenda {
    ...
    public CompositeDefaultAgenda(InternalKnowledgeBase kBase, boolean initMain) {
        for ( int i = 0; i < agendas.length; i++ ) {
            agendas[i] = new DefaultAgenda(kBase, initMain, executionStateMachine);
        }
    }
    ...
    public void setWorkingMemory( InternalWorkingMemory workingMemory ) {
        if (workingMemory.getSessionConfiguration().hasForceEagerActivationFilter()) {
            this.propagationList = new SynchronizedBypassPropagationList( workingMemory );
        } else {
            this.propagationList = new SynchronizedPropagationList( workingMemory );
        }
    ...
    public void halt() {
        if ( isFiring() ) {
            propagationList.addEntry(new DefaultAgenda.Halt( executionStateMachine ) );
            notifyWaitOnRest();
        }
    ...
    public void flushPropagations() {
        Stream.of( agendas ).forEach( DefaultAgenda::flushPropagations );
    }

    @Override
    public void flushNonMarshallablePropagations() {
        Stream.of( agendas ).forEach( DefaultAgenda::flushNonMarshallablePropagations );
    }

    @Override
    public void notifyWaitOnRest() {
        Stream.of( agendas ).forEach( DefaultAgenda::notifyWaitOnRest );
    }
    ...
    public boolean hasPendingPropagations() {
        return !propagationList.isEmpty() || Stream.of( agendas ).anyMatch( DefaultAgenda::hasPendingPropagations );
    }
    ...
    public void setFocus( String name ) {
        throw new UnsupportedOperationException( "org.drools.core.common.CompositeDefaultAgenda.setFocus -> TODO" );
    ...
    @Override
    public void clear() {
        throw new UnsupportedOperationException( "org.drools.core.common.CompositeDefaultAgenda.clear -> TODO" );
    ...
    public void executeTask( ExecutableEntry executable ) {
        throw new UnsupportedOperationException( "org.drools.core.common.CompositeDefaultAgenda.executeTask -> TODO" );

    }

    @Override
    public void activate() {
        throw new UnsupportedOperationException( "org.drools.core.common.CompositeDefaultAgenda.activate -> TODO" );

    }

    @Override
    public void deactivate() {
        throw new UnsupportedOperationException( "org.drools.core.common.CompositeDefaultAgenda.deactivate -> TODO" );

    }

    @Override
    public boolean tryDeactivate() {
        throw new UnsupportedOperationException( "org.drools.core.common.CompositeDefaultAgenda.tryDeactivate -> TODO" );
    ...
    public void registerExpiration( PropagationContext expirationContext ) {
        throw new UnsupportedOperationException( "org.drools.core.common.CompositeDefaultAgenda.registerExpiration -> TODO" );
