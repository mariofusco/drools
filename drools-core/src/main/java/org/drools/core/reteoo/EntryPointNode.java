...
public class EntryPointNode extends ObjectSource
    ...
    public void assertObject(final InternalFactHandle handle,
        ...
        if ( workingMemory.getKnowledgeBase().getConfiguration().isMultithreadEvaluation() ) {
            // If this is an async insertion we are already flushing a propagation entry, while
            ...
            // of the different agendas. In both cases we immediately propagate this insertion here
